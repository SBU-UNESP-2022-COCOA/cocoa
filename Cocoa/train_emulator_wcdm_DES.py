...
# validation_samples =      np.load('./projects/des_y3/emulator_output_cs_wcdm_NLA/lhs/dvs_for_validation_10k_IA6/validation_samples.npy')
# validation_data_vectors = np.load('./projects/des_y3/emulator_output_cs_wcdm_NLA/lhs/dvs_for_validation_10k_IA6/validation_data_vectors.npy')[:,:OUTPUT_DIM]
