    ...
    subroutine PerturbedStressEnergy(this, dgrhoe, dgqe, dgpie, sigma_ppf, & !KZ-edit: add dgpie
    ...
    real(dl), intent(in) :: grhor_t, grhog_t, pir, pig, pirdot, pigdot, grhonu_t, gpnu_t, dgpi_nu_sum, ppi_nu_dot_sum !KZ-edit
    ...
    integer, intent(in) :: w_ix
    real(dl), intent(in) :: dgpie !KZ-edit
    real(dl) :: ppiedot
    ...
    this%is_cosmological_constant = .FALSE. !KZ-edit force it to be fluid and PPF
