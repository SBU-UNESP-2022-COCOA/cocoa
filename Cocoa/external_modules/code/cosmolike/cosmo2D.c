...
const int init_static_vars_only)
{
  ...
  if (like.IA == 0 || like.IA == 1 || like.IA == 3 || like.IA == 4)
  {
    ...
    {
      return (init_static_vars_only == 1) ? int_for_C_gs_tomo_limber_withb2(amin, (void*) ar) :
        like.high_def_integration == 2 ?
    ...
    {
      return (init_static_vars_only == 1) ? int_for_C_gs_tomo_limber(amin, (void*) ar) :
        like.high_def_integration == 2 ?
  ...
  else if (like.IA == 5 || like.IA == 6)
  {
    ...
    {
      return (init_static_vars_only == 1) ? int_for_C_gs_tomo_limber_TATT(amin, (void*) ar) :
        like.high_def_integration == 2 ?
