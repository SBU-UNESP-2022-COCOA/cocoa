...
configfile = "./projects/des_y3/lhs_3x2.yaml"
config = Config(configfile)

# Training set
file = "./projects/des_y3/emulator_output_3x2_lcdm_NLA/lhs/dvs_for_training_1000k/train"

##3x2 setting; separate cosmic shear and 2x2pt
BIN_SIZE   = 900 # number of angular bins in each z-bin
BIN_NUMBER = 1 # number of z-bins

vali_path = "./projects/des_y3/emulator_output_3x2_lcdm_NLA/lhs/dvs_for_training_160k/train"
vali_number = 5000
...
validation_samples =      np.load(vali_path + '_samples.npy')[0:vali_number]
validation_data_vectors = np.load(vali_path + '_data_vectors.npy')[0:vali_number][:,:OUTPUT_DIM]
