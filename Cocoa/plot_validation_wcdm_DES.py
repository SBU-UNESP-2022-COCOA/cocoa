...
model_path = 'projects/des_y3/emulator_output_cs_wcdm_NLA/lhs/dvs_for_validation_10k_IA6/model_'
...
samples_validation = np.load('./projects/des_y3/emulator_output_cs_wcdm_NLA/lhs/dvs_for_validation_10k_IA6/validation_samples.npy')
dv_validation      = np.load('./projects/des_y3/emulator_output_cs_wcdm_NLA/lhs/dvs_for_validation_10k_IA6/validation_data_vectors.npy')
...
IA1 = samples_validation[:,12]
IA2 = samples_validation[:,13]
...
for i in range(BIN_NUMBER):
    device='cpu'
    emu = NNEmulator(config.n_dim, BIN_SIZE, config.dv_fid, config.dv_std, cov, config.dv_fid,config.dv_fid, device) #should privde dv_max instead of dv_fid, but emu.load will make it correct; same for dv_mean
...
plt.savefig("validation_chi2_wcdm_DES.pdf")
...
plt.legend()
plt.savefig("validation_wcdm_DES.pdf")
